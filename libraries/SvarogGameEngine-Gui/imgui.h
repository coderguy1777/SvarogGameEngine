...
struct ImGuiIO
{
    ...
    const char* IniFilename = "imgui.ini";                   // = "imgui.ini"    // Path to .ini file. Set NULL to disable automatic .ini loading/saving, if e.g. you want to manually load/save from memory.
